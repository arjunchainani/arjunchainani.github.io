...
const Projects = () => {
  const [selectedProjectIndex, changeSelectedProjectIndex] = useState(-1);
    ...
    <div className="projects_container">
      {ProjectNames.map((project, index) => {
        return (
          <div
            className={
              selectedProjectIndex == index ? "project selected" : "project"
            }
            onClick={(event) => {
          ...
          >
            ...
            {selectedProjectIndex == index ? (
              <p className="project_description">
                <p>
                  <a
                    href={ProjectsArray[selectedProjectIndex][0]}
                    className="git_link"
                  >
                    Github Link:
                  </a>
                </p>
                {ProjectsArray[selectedProjectIndex][1]}
              </p>
            ) : (
              <></>
            )}
